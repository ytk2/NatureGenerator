...
CLASSIC_ROCK_FAMILY = RockFamilyDefinition(
    "classic_rock",
    "Classic Rock",
...
LAYERED_ROCK_FAMILY = RockFamilyDefinition(
    "layered_rock",
    "Layered Rock",
    {"size": 50.0, "roughness": 0.42, "seed": 131, "resolution": 25},
    MacroShapeParameters(
        axis_base=(0.53, 0.43, 0.34),
        axis_response=(0.010, -0.012, -0.018),
        axis_seed_amplitude=(0.020, 0.018, 0.012),
        axis_seed_base=0.30,
        axis_seed_response=0.35,
        broad_coefficients=(0.045, 0.030, -0.030, 0.025),
        broad_amplitude_base=0.30,
        broad_amplitude_response=0.45,
        large_noise_frequency=0.56,
        large_noise_offset=(8.3, -2.7, 14.1),
        large_noise_amplitude_base=0.015,
        large_noise_amplitude_response=0.060,
        ground_offset_base=0.92,
        ground_offset_response=-0.08,
    ),
    FacetLayoutParameters(
        plane_count=4,
        scales=("medium", "large", "medium", "large"),
        normal_z_base=0.02,
        normal_z_range=0.18,
        offset_base=1.015,
        offset_response_base=0.105,
        offset_response_noise=0.018,
        weight=1.0,
    ),
    SurfaceDetailParameters(
        ...
        fbm_lacunarity=2.0,
        fbm_gain=0.48,
        fbm_offset=(6.1, -11.7, 3.4),
        fbm_octave_offset=(2.4, 1.7, -2.8),
        fbm_amplitude_base=0.008,
        fbm_amplitude_response=0.035,
        ridge_frequency=2.2,
        ridge_offset=(-3.9, 7.4, 12.6),
        ridge_center=0.40,
        ridge_amplitude_response=0.018,
        ridge_response_power=1.25,
        strata_frequency=4.8,
        strata_amplitude_base=0.028,
        strata_amplitude_response=0.075,
        strata_warp_frequency=1.15,
        strata_warp_amplitude=0.12,
    ),
)

EXPANDED_WEATHERED_ROCK_FAMILY = RockFamilyDefinition(
    "weathered_rock",
    "Weathered Rock",
    {"size": 50.0, "roughness": 0.55, "seed": 149, "resolution": 25},
    MacroShapeParameters(
        axis_base=(0.49, 0.45, 0.39),
        axis_response=(0.006, -0.010, -0.012),
        axis_seed_amplitude=(0.028, 0.025, 0.022),
        axis_seed_base=0.40,
        axis_seed_response=0.50,
        broad_coefficients=(0.075, 0.060, -0.050, 0.045),
        broad_amplitude_base=0.48,
        broad_amplitude_response=0.70,
        large_noise_frequency=0.42,
        large_noise_offset=(-9.2, 5.7, 2.6),
        large_noise_amplitude_base=0.045,
        large_noise_amplitude_response=0.150,
        ground_offset_base=0.94,
        ground_offset_response=-0.10,
    ),
    FacetLayoutParameters(
        plane_count=1,
        scales=("small",),
        ...
        normal_z_range=0.20,
        offset_base=1.075,
        offset_response_base=0.035,
        offset_response_noise=0.008,
        weight=0.75,
    ),
    SurfaceDetailParameters(
        fbm_octaves=3,
        ...
        fbm_lacunarity=1.85,
        fbm_gain=0.56,
        fbm_offset=(-12.5, 3.8, 6.9),
        fbm_octave_offset=(2.8, -2.1, 1.4),
        fbm_amplitude_base=0.030,
        fbm_amplitude_response=0.120,
        ridge_frequency=1.65,
        ridge_offset=(4.2, 9.1, -7.6),
        ridge_center=0.46,
        ridge_amplitude_response=0.010,
        ridge_response_power=1.4,
    ),
)

RIVER_ROCK_FAMILY = RockFamilyDefinition(
    "river_rock",
    "River Rock",
    {"size": 48.0, "roughness": 0.18, "seed": 167, "resolution": 25},
    MacroShapeParameters(
        axis_base=(0.55, 0.46, 0.31),
        axis_response=(0.002, -0.004, -0.006),
        axis_seed_amplitude=(0.009, 0.008, 0.005),
        axis_seed_base=0.18,
        axis_seed_response=0.18,
        broad_coefficients=(0.014, 0.010, -0.008, 0.006),
        broad_amplitude_base=0.08,
        broad_amplitude_response=0.16,
        large_noise_frequency=0.34,
        large_noise_offset=(15.4, -6.8, 3.2),
        large_noise_amplitude_base=0.003,
        large_noise_amplitude_response=0.014,
        ground_offset_base=0.93,
        ground_offset_response=-0.035,
    ),
    FacetLayoutParameters(
        plane_count=0,
        scales=(),
        ...
        normal_z_range=0.0,
        offset_base=1.1,
        offset_response_base=0.0,
        offset_response_noise=0.0,
        weight=1.0,
    ),
    SurfaceDetailParameters(
        fbm_octaves=3,
        ...
        fbm_lacunarity=1.8,
        fbm_gain=0.42,
        fbm_offset=(2.6, 13.1, -9.7),
        fbm_octave_offset=(1.9, -2.6, 2.2),
        fbm_amplitude_base=0.002,
        fbm_amplitude_response=0.012,
        ridge_frequency=1.4,
        ridge_offset=(-7.1, 3.3, 10.5),
        ridge_center=0.5,
        ridge_amplitude_response=0.0,
        ridge_response_power=1.5,
    ),
)
